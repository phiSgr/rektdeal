...
val parScore = listOf(
    listOf("NS -110", "EW 110"),
    listOf("NS 100", "EW -100"),
    listOf("NS -300", "EW 300")
)

val parString = listOf(
    listOf("NS:EW 2S", "EW:EW 2S"),
    listOf("NS:EW 4Sx", "EW:EW 4Sx"),
    listOf("NS:NS 5Hx", "EW:NS 5Hx")
)

// Number of dealer par contracts expected.
val dealerParNo = listOf(1, 1, 1)

// Dealer par scores expected.
val dealerScore = listOf(-110, 100, -300)

// Dealer par contracts expected, here only one per deal.
// That is not always the case.
val dealerContract = listOf(
    "2S-EW",
    "4S*-EW-1",
    "5H*-NS-2",
)
